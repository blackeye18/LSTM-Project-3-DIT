...
train_limit = round(0.8 * dataset.shape[1])#80% train 20% test
...
for iteration in range(0, N):
    ...
    if iteration == 0:#ari8mos proigumenwn timwn pu tha xrisimopoiei
        drop_num = 0.2
        unit_num = 50
        ...
        for i in range(0, 2):
            # Adding a second and third LSTM layer and some Dropout regularisation
