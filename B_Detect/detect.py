...
model_name='model_detect_best.h5'
...
for iteration in range(0,N):
    ...
    test_df = pd.DataFrame(index=ind_test)#ftiaxnume DataFrame etsi wste o kwdikas mas na ine simvatos me auton tis istoselidas
    ...
    #print("Average loss: ",np.average(test_mae_loss))
